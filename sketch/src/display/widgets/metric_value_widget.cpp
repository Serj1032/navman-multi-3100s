...
MetricValueWidget::MetricValueWidget(uint16_t x, uint16_t y, const char* label, const char* value, const char* unit)
    : Widget(x, y)
...
void MetricValueWidget::set_value(const char* value) {
...
void MetricValueWidget::set_units(const char* unit) {
